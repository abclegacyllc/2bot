 ...
 *
 * @module modules/cursor/buildspec/buildspec.types
 */

import type { BuildSpec } from "./buildspec.schema";

export type { BuildSpec, BuildSpecSmokeTest } from "./buildspec.schema";
...
export interface BuildSpecApplyOptions {
   ...
   * Used by `/cursor/buildspec/validate` and `/cursor/buildspec/smoke-test` endpoints.
   */
  dryRun?: boolean;
  /**
