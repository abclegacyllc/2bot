      ...
      <CardContent className="pt-0 space-y-4">
        ...
        <div className="flex items-center gap-4 text-sm">
          <div className="text-slate-500">
            <span className="text-white font-medium">{plugin.executionCount}</span> executions
          </div>
          {plugin.lastExecutedAt ? (
            ...
            <div className="text-slate-500">Never executed</div>
          )}
        </div>
        ...
        {isLoading ? (
          ...
          <Card className="border-slate-800 bg-slate-900/50">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-slate-400 mb-4">You haven&apos;t installed any plugins yet</p>
              <Button
                onClick={() => window.location.href = "/dashboard/plugins"}
                className="bg-emerald-600 hover:bg-emerald-700"
              >
