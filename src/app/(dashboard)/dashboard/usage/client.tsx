  ...
  const fetchUsage = useCallback(async () => {
    ...
    try {
      ...
      setUsage({
        ...
        gateways: { current: 2, limit: 3 },
        plugins: { current: 3, limit: 5 },
        workflows: { current: 5, limit: 10 },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="cursor-pointer transition-colors hover:bg-muted/50" onClick={() => router.push("/dashboard/settings?tab=billing")}>
        ...
        <Card className="cursor-pointer transition-colors hover:bg-muted/50" onClick={() => router.push("/dashboard/settings")}>
          <CardHeader className="flex flex-row items-center gap-4">
