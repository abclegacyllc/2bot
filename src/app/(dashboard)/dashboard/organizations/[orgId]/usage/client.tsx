 ...
 *
 * @module app/(dashboard)/dashboard/organizations/[orgId]/usage/client
 */
...
import { UsageHistoryChart, generateMockUsageData } from "@/components/quota";
import {
  Card,
  CardContent,
  CardDescription,
...
interface OrgUsageDashboardClientProps {
  orgId: string;
}
...
export function OrgUsageDashboardClient({ orgId }: OrgUsageDashboardClientProps) {
  ...
  const fetchUsage = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/orgs/${orgId}/usage`, {
        credentials: "include",
      });
  ...
  const handleUpgrade = () => {
    router.push(`/dashboard/organizations/${orgId}?tab=billing`);
  };
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/dashboard/organizations/${orgId}/quotas`}>
