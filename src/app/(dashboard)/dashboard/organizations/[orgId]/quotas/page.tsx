 ...
 *
 * URL: /dashboard/organizations/[orgId]/quotas
 *
 * @module app/(dashboard)/dashboard/organizations/[orgId]/quotas/page
 */
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [orgRes, summaryRes, allocRes, deptRes] = await Promise.all([
        ...
        fetch(`/api/orgs/${orgId}/quotas/summary`, {
          headers: { Authorization: `Bearer ${token}` },
        }),
        fetch(`/api/orgs/${orgId}/quotas/departments`, {
          headers: { Authorization: `Bearer ${token}` },
        }),
  ...
  const handleDelete = async (departmentId: string) => {
    ...
    try {
      const res = await fetch(
        `/api/orgs/${orgId}/quotas/departments/${departmentId}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        }
