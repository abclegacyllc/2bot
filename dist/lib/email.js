...
exports.sendOrganizationInviteEmail = sendOrganizationInviteEmail;
exports.sendPendingInviteEmail = sendPendingInviteEmail;
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${getEmailConfig().baseUrl}/dashboard" style="background: #667eea; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block;">Go to Dashboard</a>
    </div>
...
Go to your dashboard: ${getEmailConfig().baseUrl}/dashboard
 ...
 * @returns Email result
 */
async function sendOrganizationInviteEmail(email, organizationName, inviterName, role) {
    const invitesUrl = `${getEmailConfig().baseUrl}/dashboard/invites`;
 ...
 * @returns Email result
 */
async function sendPendingInviteEmail(email, organizationName, inviterName, role, token) {
