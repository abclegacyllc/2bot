...
exports.ENDPOINT_MIGRATIONS = void 0;
exports.deprecated = deprecated;
exports.getMigrationInfo = getMigrationInfo;
const logger_1 = require("@/lib/logger");
const deprecationLogger = logger_1.logger.child({ module: "deprecation" });
/**
 ...
 */
function deprecated(newPath, options) {
    return (req, res, next) => {
 ...
 */
function getMigrationInfo(oldEndpoint) {
    const migration = exports.ENDPOINT_MIGRATIONS[oldEndpoint];
    if (!migration)
        return null;
