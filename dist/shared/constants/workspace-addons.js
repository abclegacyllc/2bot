...
exports.ADDON_TIERS_ORDERED = exports.ALL_ADDON_TIERS = exports.WORKSPACE_ADDONS = exports.ALLOWED_ADDONS_BY_PLAN = exports.WORKSPACE_PRICING = exports.WORKSPACE_SPECS = void 0;
exports.canPurchaseAddon = canPurchaseAddon;
exports.getMinRequiredPlanForAddon = getMinRequiredPlanForAddon;
exports.getAllowedAddonsForPlan = getAllowedAddonsForPlan;
exports.calculateTotalWorkspace = calculateTotalWorkspace;
exports.hasWorkspaceEnabled = hasWorkspaceEnabled;
exports.calculateAddonsPrice = calculateAddonsPrice;
exports.getAddonTier = getAddonTier;
exports.formatWorkspaceResources = formatWorkspaceResources;
exports.formatPrice = formatPrice;
exports.getWorkspaceTierDisplay = getWorkspaceTierDisplay;
exports.getAllWorkspaceTiersForDisplay = getAllWorkspaceTiersForDisplay;
// ===========================================
...
exports.ALLOWED_ADDONS_BY_PLAN = {
...
exports.WORKSPACE_ADDONS = {
    MICRO: {
        tier: 'MICRO',
        displayName: 'Micro',
        description: 'Light automations and testing',
        ...exports.WORKSPACE_SPECS.MICRO,
        ...exports.WORKSPACE_PRICING.MICRO,
    },
    SMALL: {
        tier: 'SMALL',
        displayName: 'Small',
        description: 'Basic automation workloads',
        ...exports.WORKSPACE_SPECS.SMALL,
        ...exports.WORKSPACE_PRICING.SMALL,
    },
    MEDIUM: {
        tier: 'MEDIUM',
        displayName: 'Medium',
        description: 'Standard production workloads',
        ...exports.WORKSPACE_SPECS.MEDIUM,
        ...exports.WORKSPACE_PRICING.MEDIUM,
    },
    LARGE: {
        tier: 'LARGE',
        displayName: 'Large',
        description: 'Heavy automation and processing',
        ...exports.WORKSPACE_SPECS.LARGE,
        ...exports.WORKSPACE_PRICING.LARGE,
    },
    XLARGE: {
        tier: 'XLARGE',
        displayName: 'Extra Large',
        description: 'Maximum power for enterprise workloads',
        ...exports.WORKSPACE_SPECS.XLARGE,
        ...exports.WORKSPACE_PRICING.XLARGE,
    },
};
// ===========================================
// Helper Arrays
// ===========================================
exports.ALL_ADDON_TIERS = ['MICRO', 'SMALL', 'MEDIUM', 'LARGE', 'XLARGE'];
// Ordered by size (for UI display)
exports.ADDON_TIERS_ORDERED = ['MICRO', 'SMALL', 'MEDIUM', 'LARGE', 'XLARGE'];
// ===========================================
// Helper Functions
// ===========================================
/**
 ...
 */
function canPurchaseAddon(plan, tier) {
    return exports.ALLOWED_ADDONS_BY_PLAN[plan]?.includes(tier) ?? false;
}
 ...
 */
function getMinRequiredPlanForAddon(tier) {
    for (const plan of PLAN_ORDER) {
        if (exports.ALLOWED_ADDONS_BY_PLAN[plan]?.includes(tier)) {
 ...
 */
function getAllowedAddonsForPlan(plan) {
    return exports.ALLOWED_ADDONS_BY_PLAN[plan] ?? [];
}
/**
 * Calculate total workspace resources from plan + add-ons (STACKING mode)
 */
function calculateTotalWorkspace(planWorkspace, addons) {
    const total = {
    ...
    for (const addonTier of addons) {
        const addon = exports.WORKSPACE_ADDONS[addonTier];
 ...
 */
function hasWorkspaceEnabled(planWorkspace, addons) {
    return planWorkspace !== null || addons.length > 0;
}
/**
 * Calculate monthly price for selected add-ons
 */
function calculateAddonsPrice(addons, yearly = false) {
    return addons.reduce((total, tier) => {
        const pricing = exports.WORKSPACE_PRICING[tier];
 ...
 */
function getAddonTier(tierName) {
    const normalized = tierName.toUpperCase();
    return exports.ALL_ADDON_TIERS.includes(normalized) ? normalized : null;
}
/**
 * Format workspace resources for display
 */
function formatWorkspaceResources(resources) {
 ...
 */
function formatPrice(cents, yearly = false) {
 ...
 */
function getWorkspaceTierDisplay(tier) {
    const addon = exports.WORKSPACE_ADDONS[tier];
    return {
 ...
 */
function getAllWorkspaceTiersForDisplay() {
    return exports.ADDON_TIERS_ORDERED.map(tier => ({
        tier,
        ...getWorkspaceTierDisplay(tier),
        addon: exports.WORKSPACE_ADDONS[tier],
    }));
}
//# sourceMappingURL=workspace-addons.js.map