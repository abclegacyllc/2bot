...
exports.ORG_PLAN_ORDER = exports.ORG_PLAN_UPGRADE_PATHS = exports.ORG_PLAN_STRIPE_PRICES = exports.PAID_ORG_PLAN_TYPES = exports.ALL_ORG_PLAN_TYPES = exports.ORG_PLAN_LIMITS = exports.INCLUDED_ORG_WORKSPACE_POOL = exports.ORG_WORKSPACE_POOL_SPECS = void 0;
exports.getIncludedOrgWorkspacePool = getIncludedOrgWorkspacePool;
exports.isHigherOrgPlan = isHigherOrgPlan;
exports.isAtLeastOrgPlan = isAtLeastOrgPlan;
exports.getOrgPlanLimits = getOrgPlanLimits;
exports.orgPlanHasFeature = orgPlanHasFeature;
exports.isOrgLimitExceeded = isOrgLimitExceeded;
exports.getOrgRemainingCapacity = getOrgRemainingCapacity;
exports.calculateExtraSeatsPrice = calculateExtraSeatsPrice;
exports.formatOrgPoolResources = formatOrgPoolResources;
exports.getOrgPlanFeatures = getOrgPlanFeatures;
exports.getAllOrgPlansForDisplay = getAllOrgPlansForDisplay;
exports.getOrgUpgradePlansForDisplay = getOrgUpgradePlansForDisplay;
exports.ORG_WORKSPACE_POOL_SPECS = {
    NONE: {
...
exports.INCLUDED_ORG_WORKSPACE_POOL = {
 ...
 */
function getIncludedOrgWorkspacePool(plan) {
    const tier = exports.INCLUDED_ORG_WORKSPACE_POOL[plan];
    return exports.ORG_WORKSPACE_POOL_SPECS[tier];
}
// ===========================================
 ...
 */
exports.ORG_PLAN_STRIPE_PRICES = {
 ...
 */
exports.ORG_PLAN_UPGRADE_PATHS = {
 ...
 */
function isHigherOrgPlan(planA, planB) {
    return exports.ORG_PLAN_ORDER[planA] > exports.ORG_PLAN_ORDER[planB];
}
/**
 * Check if org plan is at least as good as another
 */
function isAtLeastOrgPlan(userPlan, requiredPlan) {
    return exports.ORG_PLAN_ORDER[userPlan] >= exports.ORG_PLAN_ORDER[requiredPlan];
}
/**
 * Get the limits for an org plan
 */
function getOrgPlanLimits(plan) {
    return exports.ORG_PLAN_LIMITS[plan];
}
/**
 * Check if org plan has a specific feature
 */
function orgPlanHasFeature(plan, feature) {
    return exports.ORG_PLAN_LIMITS[plan].features[feature];
}
/**
 ...
 */
function isOrgLimitExceeded(current, limit) {
    if (limit === -1)
 ...
 */
function getOrgRemainingCapacity(current, limit) {
    if (limit === -1)
        return -1; // Unlimited
 ...
 */
function calculateExtraSeatsPrice(plan, extraSeats, yearly = false) {
    const limits = exports.ORG_PLAN_LIMITS[plan];
 ...
 */
function formatOrgPoolResources(pool) {
 ...
 */
function getOrgPlanFeatures(plan) {
    const limits = exports.ORG_PLAN_LIMITS[plan];
    const features = [];
    // Seats
...
function getAllOrgPlansForDisplay() {
    return exports.ALL_ORG_PLAN_TYPES.map(planId => {
        const limits = exports.ORG_PLAN_LIMITS[planId];
        return {
            id: planId,
 ...
 */
function getOrgUpgradePlansForDisplay() {
    return getAllOrgPlansForDisplay();
}
//# sourceMappingURL=org-plans.js.map